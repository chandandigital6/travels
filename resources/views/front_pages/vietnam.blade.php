    ...
    <div class="container-fluid p-0">
        ...
        <div class="position-relative">
            ...
            <div class="position-absolute top-50 start-50 translate-middle text-white text-center bg-dark bg-opacity-75 p-4 rounded"
                ...
                <h1 class="display-4 text-warning mb-4" style="font-size: 3.5rem;">Vietnam <span
                        class="text-warning">Itinerary</span></h1>
                <div class="breadcrumb d-flex justify-content-center">
                    <a href="{{ route('home') }}" class="text-white text-decoration-none mx-2">Home</a>
                    <span class="text-white mx-2">/</span>
                    <a href="{{ route('vietnam') }}" class="text-white text-decoration-none mx-2">Vietnam Itinerary</a>
                </div>
            </div>
        </div>
        ...
        {{-- <div class="container-fluid destination py-5">
            <div class="container">
                <div class="mx-auto text-center mb-5" style="max-width: 900px;">
                    <h5 class="section-title px-3">Destination</h5>
                    <h1 class="mb-0">Vietnam Destinations</h1>
                </div>
                <div class="tab-class text-center">
                    <div class="tab-content">
                        <!-- Kashmir Itinerary -->
