                ...
                <div class="card">
                    <div class="card-header bg-primary text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h1>States</h1>
                            <a href="{{ route('state.create') }}" class="btn btn-light">Create </a>
                        </div>
                    </div>
                                ...
                                @forelse ($stateData as $state)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('state.delete', $state->id) }}" class="btn btn-danger">Delete</a>
                                            <!-- Add delete button if needed -->
                                            <a href="{{ route('state.duplicate', $state->id) }}" class="btn btn-warning">Duplicate</a>
